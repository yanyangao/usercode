...
OUTPUTDIR=/afs/cern.ch/user/y/yygao/scratch0/hwwjcp_19p5fb_statonly/
...
for NEXP in \$(seq \${MIN} \${MAX})
  ...
  cp mlfit.root /tmp/yygao/CMSSW_5_3_3/src/mlfit_injm${INJ}_m\${MASS}_${ANA}of_${NJETS}j_id\${NEXP}.root 
...
cp /tmp/yygao/CMSSW_5_3_3/src/mlfit_* $OUTPUTDIR/logsNorm/\${MASS}/
cd /tmp/yygao/
rm -rf CMSSW_5_3_3
EOF
