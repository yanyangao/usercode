...
OUTPUTDIR=/afs/cern.ch/user/j/jaehyeok/CMSSW_5_2_3_patch4/src/Smurf/LimitCalc/ana_PostHCP_2D_19fb/
...
echo 'processing mass='\${MASS} analysis ${ANA} $NJET jet>> /tmp/jaehyeok/CMSSW_5_3_3/src/log_\${INJ}_\${MASS}_\${MIN}_\${MAX}_$ANA_${NJETS}j_summary.log
for NEXP in \$(seq \${MIN} \${MAX})
  ...
  python ../../../HiggsAnalysis/CombinedLimit/test/mlfitNormsToText.py mlfit.root >> /tmp/jaehyeok/CMSSW_5_3_3/src/logNorm_\${INJ}_\${MASS}_${ANA}of_${NJETS}j_shape_8TeV_\${MIN}_\${MAX}.log
  python ../../../HiggsAnalysis/CombinedLimit/test/diffNuisances.py -a mlfit.root >> /tmp/jaehyeok/CMSSW_5_3_3/src/logNuis_\${INJ}_\${MASS}_${ANA}of_${NJETS}j_shape_8TeV_\${MIN}_\${MAX}.log
  cp mlfit.root /tmp/jaehyeok/CMSSW_5_3_3/src/mlfit_injm${INJ}_m\${MASS}_${NJETS}j_id\${NEXP}.root 
  rm mlfit.root higgsCombineTest.MaxLikelihoodFit.mH125.root
  cd /tmp/jaehyeok/CMSSW_5_3_3/src
done
...
cp /tmp/jaehyeok/CMSSW_5_3_3/src/log* $OUTPUTDIR/logsNorm/\${MASS}/
cp /tmp/jaehyeok/CMSSW_5_3_3/src/mlfit_* $OUTPUTDIR/logsNorm/\${MASS}/
cd /tmp/jaehyeok/
rm -rf CMSSW_5_3_3
EOF
